...
I imported the full text of speeches and created a new column named `text` in `speech.list` to store them.
```{r, message=FALSE, warning=FALSE}
...
From the barplots, both two groups had more anticipation than joy and more sadness than surprise. However, Trump had more joy than anticipation and more surprise than sadness. In conclusion, comparing to other presidents, Trump was more positive and had less emotions of fear, anger, sadness and disgust.
...
Based on the 15 topics, I created a cluster plot. In this plot, Trump was in the part which included one-term presidents more.
